		        ...
		        <div class="modal-dialog" role="document">
		         ...
		         <form id="frm-btn" method="POST">
				                ...
				                <strong class="reason_title">사유선택</strong>
				                  <div class="list_type">
				                    <ui style="list-style: none">
				                      <li class="list">
				                       <input type="radio" name="select" id="sel1" class="report_reason" value="1">
				                         <div class="check_area">
				                           <label for="sel1">스팸홍보/도배글입니다.</label>
				                         </div>
				                      </li>
				                      <li class="list">
				                       <input type="radio" name="select" id="sel2" class="report_reason" value="2">
				                         <div class="check_area">
				                           <label for="sel2">음란물입니다.</label>
				                         </div>
				                      </li>
				                      <li class="list">
				                           <input type="radio" name="select" id="sel3" class="report_reason" value="3">
				                         <div class="check_area">
				                           <label for="sel3">불법정보를 포함하고 있습니다.</label>
				                         </div>
				                      </li>
				                      <li class="list">
				                       <input type="radio" name="select" id="sel4" class="report_reason" value="4">
				                         <div class="check_area">
		            ...
		            <div class="modal-footer">
		                <a class="btn btn-danger w-50" id="modalY" href="#">신고하기</a>
...
const fnRemoveBlog = () => {
  $('#btn-remove-blog').on('click', (evt) => {
    ...
    if(confirm('블로그를 삭제하면 모든 댓글이 함께 삭제됩니다. 삭제할까요?')){
      frmBtn.attr('action', '${contextPath}/anon/removeAnon.do');
      frmBtn.submit();
    }
  })
}
